         ...
         {loading ? (
            ...
            <ul className='content-search-result-artist'>
               {getResultArtist.data.map((artist: ArtistNavbar) => (
                  <li key={artist.id} className='result-playlist-item'>
                     <div className='result-artist-image'>
                        <figure>
                           <img src={artist.picture_medium} alt='Image Artist Artist' />
                           <ul className='action'>
...
export default SearchNavBarArtist;
