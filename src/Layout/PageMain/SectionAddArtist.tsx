...
const SectionAddArtist = () => {
   ...
   const [fetchPictureDefault, loading] = useAxiosFetch(
      '/artists?ids=2CIMQHirSU0MQqyYHq0eOx,57dN52uHvrHOxijzpIgu3E,1vCWHaC5f2uS3yhpwWbIA6,1mcTU81TzQhprhouKaTkpq,0du5cEVh5yTK9QJze8zA0C'
   );

   const handleAddArtist = async () => {
      const result = await axios.get(`${baseURL}/search?q=a&type=artist&market=ES&limit=50`, {
         method: 'GET',
                  ...
                  {loading ? (
                     ...
                     fetchPictureDefault?.artists.map((picture: ArtistPicture) => (
                        <div
                           ...
                           onClick={() => setShowModalChannel(!showModalChannel)}
                        >
                           <figure>
