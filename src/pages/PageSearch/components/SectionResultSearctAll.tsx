...
const SectionResultSearctAll = () => {
   const { valueSearch, loading } = useContext(AppContext);
            ...
            {loading ? (
               ...
               <div className='search-top-result'>
                  <div className='search-top-result-image'>
                     <figure>
                        <img src={valueSearch[0]?.artist.picture_xl} alt='Image Search Result' />
                     </figure>
                  </div>
         ...
         <div className='container'>
            ...
            <div className='music-result-data'>
               {valueSearch.slice(0, 5).map((value: SearchResult) => (
                  <div key={value.id} className='music-result-data-content'>
                     <div className='song-data'>
                        <div className='song-data-image'>
                           <img src={value.album.cover_small} alt='Imagen Music' width={'40'} height={'40'} />
                        </div>
                        <p>{value.title}</p>
...
export default SectionResultSearctAll;
