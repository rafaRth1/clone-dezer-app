...
const PagePlayer = () => {
   const { getArrayMusic, currentTrack, handlePlayMusic } = useContext(AppContext);
            ...
            <div className='player-controls'>
               <ul className='svg-icon-groups'>
                  <li className='svg-icon-item'>
                     <button>
                        <IoPlaySkipBackOutline color='white' size={26} />
                     </button>
                  </li>
                  <li className='svg-icon-item'>
                     <button onClick={() => console.log('Play')}>
                        <IoPlay color='white' size={26} />
                     </button>
                  </li>
                  <li className='svg-icon-item'>
                     <button onClick={() => console.log('Siguiente')}>
                        <IoPlaySkipForwardOutline color='white' size={26} />
                     </button>
                  </li>
               </ul>
            </div>
                  ...
                  <div className='track-seekbar'>
                     <div className='slider-autohide'>
                        ...
                        <div className='slider-track'>
                           <audio controls preload='none' id='track'></audio>
                        </div>
